...
%
par_wor_name='wppcont1';       % ['STRING'] 8-char (output) config name
par_gcm='k2';                % ['STRING'] input format/GCM name
par_expid='wppcont1';          % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
par_tauopt=1;                  % [0/1/2/3] zonal windstress option
