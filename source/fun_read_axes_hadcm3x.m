function [axisloncm,axislonce,axislatcm,axislatce,axislonpm,axislonpe,axislatpm,axislatpe,axislonam,axislonae,axislatam,axislatae] = fun_read_axes_hadcm3x(str)
%
%%
