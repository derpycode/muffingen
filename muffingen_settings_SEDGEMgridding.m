...
%
par_wor_name='sed_grid';       % ['wppcont1'] 8-char (output) config name
par_gcm='k1';                % ['mask'] input format/GCM name
par_expid='p0251b';          % ['wppcont1'] input experiment/data name
...
opt_makeocean=false;            % [false/true] create ocean files?
